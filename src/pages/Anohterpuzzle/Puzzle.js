...
const Puzzle = () => {
    ...
    function checkAnswer() {
        if (guess.toUpperCase() === words[currentLevel]) {
                ...
                <div className="row">
                    <div className="col-12 my-2">
                        ...
                        <ul className="mar me-5">
                            ...
                            <li>'If Word puzzles are matched' </li>
                            <li>'Player wins this game' </li>
                            <li>'Otherwise, Restart the jigsawplanet puzzle game again and try to match again 3 cards </li>
                        </ul>
                        <h3 className="mt-4 up">3. Set up Your Space:</h3>
                        <h6 className="puzzle-game-intro me-5">For physical puzzle game, ensure you have a comfortable and well-lit workspace. For digital jigsawplanet, adjust your device's brightness and volume settings to suit your environment and mind.</h6>
